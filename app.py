    ...
    if request.method == 'POST':
        try:
            ...
            nova_tarefa = Tarefa(
                ...
                notif_enviada_1=False,
                notif_datetime_2=notif_dt_2,
                notif_enviada_2=False,
            )
